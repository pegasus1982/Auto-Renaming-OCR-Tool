...
namespace RecogCaptcha
{
    public partial class Form1 : Form
    {
        ...
        private string reconhecerCaptcha(Image img)
        {
            ...
            cor.Blue = new AForge.IntRange(110, 255);
            cor.Red = new AForge.IntRange(110, 255);
            cor.Green = new AForge.IntRange(110, 255);
            ...
            imagem = inverter.Apply(imagem);
            imagem = cor.Apply(imagem);
            //imagem = erosion.Apply(imagem);
            //imagem = dilatation.Apply(imagem);
            //imagem = gs.Apply(imagem);
            //imagem = close.Apply(imagem);
            //imagem = close.Apply(imagem);
            //imagem = close.Apply(imagem);
            //imagem = open.Apply(imagem);
            //imagem = open.Apply(imagem);
        ...
        private string OCR(Bitmap b)
        {
            ...
            {
                engine.SetVariable("tessedit_char_whitelist", "123456789ABCDEF");
